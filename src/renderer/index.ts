        ...
        setTimeout(
            () =>
                Alerts.show({
                    ...
                    body: "Due to security hardening changes in Pancord, your custom Equicord location had to be reset. Please configure it again in the settings.",
