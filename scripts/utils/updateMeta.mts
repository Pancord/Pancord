...
const latestReleaseInformation = await fetch("https://api.github.com/repos/Pancord/Pancord/releases/latest", {
    headers: {
...
const metaInfo = await fs.readFile("./meta/io.github.pancord.pancord.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/io.github.pancord.pancord.metainfo.xml", output, "utf-8");
